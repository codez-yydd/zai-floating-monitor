...
export const theme = {
  ...
  // 随会话条数自适应，最多显示 5 条超出折叠） =====
  "theme.hudTitle": "会话悬浮窗",
  "theme.hudHint":
    "独立透明置顶小窗，实时显示当前活跃 ZCode 会话的模型、状态（生成中/空闲）与累计 Token（Σ 总计 · ↑ 输入 · ↓ 输出 · ⟲ 缓存读 · × 请求 · 速度 t/s · TTFT，口径同注入版会话条），多会话并列、按最近活动排序；不依赖皮肤安装，可拖动移动位置、拖拽边缘自由调整大小（顶部滑块可调字体大小）。",
